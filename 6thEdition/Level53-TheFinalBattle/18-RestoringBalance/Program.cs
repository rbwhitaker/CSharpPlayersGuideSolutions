...
List<Party> monsterParties = new List<Party>
            {
                CreateMonsterParty1(player2),
                CreateMonsterParty2(player2),
                CreateMonsterParty3(player2),
                CreateMonsterParty4(player2),
                CreateMonsterParty5(player2),
                CreateMonsterParty6(player2)
            };
...
// Create the monster party for Battle 5
Party CreateMonsterParty5(IPlayer controllingPlayer)
{
    Party monsters = new Party(controllingPlayer);
    monsters.Characters.Add(new Skeleton());
    monsters.Characters.Add(new Skeleton());
...
// Create the monster party for Battle 6
Party CreateMonsterParty6(IPlayer controllingPlayer)
{
    Party monsters = new Party(controllingPlayer);
