...
Party[] monsterParties = new Party[]
            {
                CreateMonstersForBattle1(),
                CreateMonstersForBattle2(),
                CreateMonstersForBattle3(),
                CreateMonstersForBattle4(),
                CreateMonstersForBattle5(),
                CreateMonstersForBattle6()
            };
...
{
    Party monsters = new Party();
    monsters.Characters.Add(new TheHandOfTheUncodedOne());
    monsters.Items.Add(new HealthPotion());
    monsters.Items.Add(new HealthPotion());
    return monsters;
}

// Create the monsters for Battle #4.
Party CreateMonstersForBattle4()
{
    Party monsters = new Party();
...
// Create the monsters for Battle #5.
Party CreateMonstersForBattle5()
{
    Party monsters = new Party();
    monsters.Characters.Add(new Skeleton());
    monsters.Characters.Add(new Skeleton());
...
// Create the monsters for Battle #6.
Party CreateMonstersForBattle6()
{
    Party monsters = new Party();
